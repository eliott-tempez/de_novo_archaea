# This script calculates, for each de novo gene, the number of noncoding matches
# that have a severed integrity in the furthest outgroup (low_qcov_last_outgroup.tsv)
# and the before last outgroup (low_qcov_before_last_outgroup.tsv).
# It saves names of the the de novo genes with at least 80% of their 
# noncoding matches with a severed integrity in both outgroups 
# (good_candidates.txt).

library(dplyr)


input_file = "/home/eliott.tempez/Documents/M2_Stage_I2BC/results/4_integrity_analysis/nc_coverage.tsv"
