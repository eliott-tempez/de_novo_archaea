...
if __name__ == "__main__":
    ...
    # Save the results
    df = pd.DataFrame(results, columns=["genome", "cds", "aggreg", "type"])
    df.to_csv(os.path.join(OUT_DIR, "sequence_features_good_candidates_all_tango.csv"), sep="\t", index=False)